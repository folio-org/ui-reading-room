...
export default class NoteView extends Component {
  ...
  getActionMenu = ({ onToggle }) => {
    ...
    const canAssignUnassign = stripes.hasPerm('ui-notes.item.assign-unassign') || stripes.hasPerm('ui-notes.item.assign-unassign.execute');
    ...
    return (
      <>
        {
          canUnassign
          && (stripes.hasPerm('ui-notes.item.assign-unassign') || stripes.hasPerm('ui-notes.item.assign-unassign.execute')) &&
            <Button
