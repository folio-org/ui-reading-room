...
jest.mock('../components/Notes/NotesSmartAccordion', () => jest.fn().mockImplementation((props) => {
  const RealNotesSmartAccordion = jest.requireActual('../components/Notes/NotesSmartAccordion').default;

  return (
    <RealNotesSmartAccordion
      {...props}
      open
      resources={{
        assignedNotes: {
